...
Color darkGrayColor = Color(0xFF535760);
Color redButtonColor = Color(0xFFF00027);
Color blueColor = Color(0xFF124888);
Color orangeColor = Color(0xFFFAA424);
Color lightGrayColor = Color(0xFFEDECF1);
Color browColor = Color(0xFFB54618);
Color bluePureColor = Color(0xFF1D13E5);
Color pinkColor = Color(0xFFFEE5E7);
Color blackColor = Color(0xFF00000);
Color silverColor = Color(0xFF90A4AE);

TextStyle bottonNavText =
